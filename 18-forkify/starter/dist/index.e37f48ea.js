...
const KEY = "ef6a0551-59d3-451e-a188-550681f58937";
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        <div class="recipe__user-generated ${this._data.key ? "" : "hidden"}">
            <svg>
                <use href="${0, _iconsSvgDefault.default}g#icon-user"></use>
            </svg>
        </div>
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._nextButton(curPage);
        // Last Page
        if (curPage === numPages && numPages > 1) return this._prevButton(curPage);
        // Other Page
        if (curPage < numPages) return `${this._prevButton(curPage)} ${this._nextButton(curPage)}`;
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"1FDQ6"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
